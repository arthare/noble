...
NobleBindings.prototype.onDiscover = function (status, address, addressType, connectable, advertisement, rssi, rawData, dataInitial, dataScanrsp) {
  ...
  if (hasScanServiceUuids) {
    ...
    this.emit('discover', uuid, address, addressType, connectable, advertisement, rssi, rawData, dataInitial, dataScanrsp);
  }
};
